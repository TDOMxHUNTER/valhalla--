...
export default function Roadmap() {
  ...
  return (
    <section 
      className="py-20 bg-black min-h-screen bg-cover bg-center bg-no-repeat bg-fixed"
      style={{
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {roadmapPhases.map((phase, index) => (
              ...
              >
                <div className={`lg:w-1/2 ${index % 2 === 0 ? 'lg:pr-8' : 'lg:pl-8'} mb-6 lg:mb-0`}>
                  <Card className={`bg-viking-dark/90 backdrop-blur-sm ${getStatusColor(phase.status)} shadow-xl`}>
        ...
        {/* Token Distribution */}
        <Card className="bg-rune-gray/90 backdrop-blur-sm border-nordic-gold/30 shadow-2xl">
          <CardHeader>
          ...
          <CardContent className="p-8">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              {/* Token Info */}
              <div className="bg-viking-dark/90 backdrop-blur-sm rounded-xl p-6 shadow-lg">
